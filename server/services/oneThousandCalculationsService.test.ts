...
const nomisDates = {
  ...
  mtdCalculatedDate: '2022-01-14',
  mtdOverrideDate: '',
  etdCalculatedDate: '2022-01-13',
  etdOverrideDate: '',
  ltdOverrideDate: '',
  ltdCalculatedDate: '2022-01-15',
  ...
  describe('OneThousandCalculationsService tests', () => {
    ...
    it('Test that a prison-api error will return a CSV row', async () => {
      ...
      const expected = {
        ...
        HDCED_MATCH: '',
        NOMIS_ETD: undefined,
        NOMIS_ETD_CALCULATED: undefined,
        NOMIS_ETD_OVERRIDE: undefined,
        ETD_MATCH: '',
        NOMIS_MTD: undefined,
        NOMIS_MTD_CALCULATED: undefined,
        NOMIS_MTD_OVERRIDE: undefined,
        MTD_MATCH: '',
        NOMIS_LTD: undefined,
        NOMIS_LTD_CALCULATED: undefined,
        NOMIS_LTD_OVERRIDE: undefined,
        LTD_MATCH: '',
