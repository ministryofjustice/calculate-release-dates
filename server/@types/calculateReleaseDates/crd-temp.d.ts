/**
 * TODO This file will be deleted as a tech debt ticket to remove GANT chart functionality from the UI.
 * It contains remnants from the diagram functionality that has been removed from the api but not removed from the UI.
 */
