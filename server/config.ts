...
export default {
  ...
  apis: {
    ...
    hmppsAuth: {
      ...
      authClientId: get('AUTH_CODE_CLIENT_ID', 'calculate-release-dates-client', requiredInProduction),
      authClientSecret: get('AUTH_CODE_CLIENT_SECRET', 'clientsecret', requiredInProduction),
      systemClientId: get('CLIENT_CREDS_CLIENT_ID', 'calculate-release-dates-admin', requiredInProduction),
      systemClientSecret: get('CLIENT_CREDS_CLIENT_SECRET', 'client_secret', requiredInProduction),
    },
    manageUsersApi: {
