...
export default {
  ...
  apis: {
    ...
    hmppsAuth: {
      ...
      authClientId: get('AUTH_CODE_CLIENT_ID', 'calculate-release-dates-admin', requiredInProduction),
      authClientSecret: get('AUTH_CODE_CLIENT_SECRET', 'client_secret', requiredInProduction),
      systemClientId: get('CLIENT_CREDS_CLIENT_ID', 'calculate-release-dates-client', requiredInProduction),
