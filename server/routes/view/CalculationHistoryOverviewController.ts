...
export default class CalculationHistoryOverviewController implements Controller {
  ...
  private createModelFromDetailedCalculationResults(
    ...
    return new CalculationHistoryOverviewViewModel(
      ...
      detailedResults.context.genuineOverrideReasonDescription,
      detailedResults.secondCheckDetails,
      history,
      config.calculationHistory.pageSize,
      calculationSummaryDatesPanelModelFromCalculationSummaryViewModel(Object.values(detailedResults.dates)),
      detailedResults.overriddenDates
        ? calculationSummaryDatesPanelModelFromCalculationSummaryViewModel(
            Object.values(detailedResults.overriddenDates),
          )
        : null,
      courtCaseCount,
      sentenceCount,
  ...
  private createModelFromNomisCalculationSummary(
    ...
    return new CalculationHistoryOverviewViewModel(
      ...
      history,
      config.calculationHistory.pageSize,
      calculationSummaryDatesPanelModelFromCalculationSummaryViewModel(nomisCalculationSummary.releaseDates),
      null,
      null,
      null,
      [],
