...
export default class OtherRoutes {
  ...
  private addRow(
    ...
    const row = {
      ...
      NOMIS_LED_CALCUATED: nomisDates.licenseExpiryCalculatedDate,
      ...
      NOMIS_SED_CALCUATED: nomisDates.sentenceExpiryCalculatedDate,
      ...
      NOMIS_PED_CALCUATED: nomisDates.paroleEligibilityCalculatedDate,
